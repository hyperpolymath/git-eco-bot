image:[MPL-2.0,link="https://opensource.org/licenses/PMPL-1.0"]
...
----
  ...
  |  Gas Analysis    | Allocative Efficency   |
  +-------------------------------------------+
----
...
This project is dual-licensed under **PMPL-1.0-or-later** (your choice).
